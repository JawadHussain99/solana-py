...
class _HTTPProviderCore:  # pylint: disable=too-few-public-methods
    ...
    def _build_request_kwargs(self, body: Body) -> Dict[str, Any]:
        ...
        data = body.to_json()
        return {**common_kwargs, "json": data}
...
def _after_request_unparsed(raw_response: requests.Response) -> str:
    raw_response.raise_for_status()
    return raw_response.text


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup) -> _RespTup:
    ...


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup1) -> _RespTup1:
    ...


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup2) -> _RespTup2:
    ...


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup3) -> _RespTup3:
    ...


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup4) -> _RespTup4:
    ...


@overload
def _after_batch_request(raw_response: requests.Response, parsers: _Tup5) -> _RespTup5:
    ...


def _after_batch_request(raw_response: requests.Response, parsers: _Tuples) -> Tuple[RPCResult, ...]:
